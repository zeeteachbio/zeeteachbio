...
function renderDashboard(filterText = '') {
    ...
    let groupsToShow = [];
    if (currentTab === 'STB') {
        groupsToShow = ['STB Class 9', 'STB Class 10', 'STB Class 11', 'STB Class 12'];
    } else if (currentTab === 'AKUEB') {
        groupsToShow = ['AKUEB Class 9', 'AKUEB Class 10', 'AKUEB Class 11', 'AKUEB Class 12'];
    } else {
        // 'Other' tab
        groupsToShow = [];
    }
